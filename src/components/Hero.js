        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className="w-full lg:w-1/2 xl:w-1/2 mb-8 lg:mb-0 text-center lg:text-left lg:pl-8">
            <h1 className="text-4xl md:text-5xl font-bold mb-3">
              <span className="text-purple-500">Vibe</span> Gaming Hub
            </h1>
            <p className="text-gray-300 text-base mb-5 mx-auto lg:mx-0">
              Discover vibe-coded entertainment built by Grok and similar AI tools like claude, cursor, and three.js. Play AI-generated games, join a vibejam competition, use our gig marketplace to connect with game devs and creatives, or browse our vibegame index—all in one vibrant community.
            </p>
