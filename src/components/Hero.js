...
export default function Hero() {
  ...
  return (
    <div className="relative bg-grok-dark pt-20 pb-16 overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
          {/* Hero Content */}
          <div className="w-full lg:w-1/2 max-w-xl text-center lg:text-left mx-auto lg:mx-0">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white mb-6">
              <span className="text-grok-purple">AI Gaming</span> Vibe Hub
            </h1>
            <p className="text-grok-text-secondary text-lg mb-8">
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end mt-8 lg:mt-0">
            <div className="w-full max-w-[320px] sm:max-w-md bg-grok-card rounded-lg overflow-hidden shadow-lg relative">
              ...
              <div className="p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-bold text-white mb-1">Brick Breaker</h3>
                <p className="text-grok-text-secondary mb-3 sm:mb-4">Featured Game</p>
                
                <div className="flex justify-between items-center mb-3 sm:mb-4">
                  <span className="text-grok-text-secondary text-xs sm:text-sm">0 views</span>
                  <span className="bg-gray-700 text-xs text-white px-2 py-1 rounded">PRODUCTION</span>
                </div>
                
                <Link href="/game/brick-breaker" className="block w-full bg-grok-purple hover:bg-purple-800 text-white py-2 sm:py-3 px-4 rounded-md transition-colors duration-300 text-center">
                  View Game
                </Link>
              </div>
            </div>
