...
// Fallback component while content is loading
function ComingSoonFallback() {
  return (
    <div className="flex-grow flex flex-col items-center justify-center p-4">
      <div className="max-w-lg w-full bg-black bg-opacity-60 backdrop-blur-md rounded-lg p-8 shadow-2xl border border-purple-900">
        <div className="flex justify-center mb-6">
          <div className="w-24 h-24 rounded-full bg-grok-purple flex items-center justify-center animate-pulse">
          </div>
        </div>
        <h1 className="h-8 bg-gray-700 rounded animate-pulse mb-4"></h1>
        <p className="h-4 bg-gray-700 rounded animate-pulse mb-2"></p>
        <p className="h-4 bg-gray-700 rounded animate-pulse mb-8"></p>
        <div className="space-y-6">
          <div className="bg-grok-purple bg-opacity-20 p-4 rounded-lg border border-purple-700">
            <h3 className="h-5 bg-purple-900 rounded animate-pulse mb-4 w-1/3"></h3>
          ...
          <div className="text-center">
            <p className="h-4 bg-gray-700 rounded animate-pulse mb-4 w-2/3 mx-auto"></p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <div className="h-10 bg-purple-900 rounded animate-pulse w-full sm:w-40"></div>
              <div className="h-10 bg-gray-700 rounded animate-pulse w-full sm:w-40"></div>
            </div>
          </div>
        </div>
      </div>
